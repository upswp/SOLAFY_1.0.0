...
public interface ProblemSetMapper {
	 ...
	 */
	public ProblemSetDto selectProblemSetMapping(Map<String, Integer> map);
	 ...
	 */
	public int createProblemSetMapping(Map<String, Integer> map);
	 ...
	 * @return int 수정된 행의 갯수 반환
	 */
	public int updateProblemSetMapping(Map<String, Integer> map);
	 ...
	 */
	public int deleteProblemSetMapping(Map<String, Integer> map);
}
