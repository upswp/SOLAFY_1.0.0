...
-- -----------------------------------------------------
-- Table `solafy`.`userinfo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `solafy`.`userinfo` (
...
CREATE TABLE IF NOT EXISTS `solafy`.`problem` (
  ...
  CONSTRAINT `problem_uid_usernickname_uid`
    FOREIGN KEY (`uid`)
    REFERENCES `solafy`.`userinfo` (`uid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `solafy`.`categoryLMmapping`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `solafy`.`categoryLMmapping` (
  `largeCategoryNo` INT NOT NULL,
  `mediumCategoryNo` INT NOT NULL,
  PRIMARY KEY (`largeCategoryNo`, `mediumCategoryNo`),
  INDEX `categoryLMmapping_largeCategoryNo_categorymedium_categoryNo_idx` (`mediumCategoryNo` ASC) VISIBLE,
  CONSTRAINT `categoryLMmapping_largeCategoryNo_categorylarge_categoryNo`
    FOREIGN KEY (`largeCategoryNo`)
    REFERENCES `solafy`.`categorylarge` (`categoryNo`)
    ON DELETE CASCADE
    ON UPDATE RESTRICT,
  CONSTRAINT `categoryLMmapping_largeCategoryNo_categorymedium_categoryNo`
    FOREIGN KEY (`mediumCategoryNo`)
...
-- -----------------------------------------------------
-- Table `solafy`.`categoryMSmapping`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `solafy`.`categoryMSmapping` (
  `mediumCategoryNo` INT NOT NULL,
  `smallCategoryNo` INT NOT NULL,
  PRIMARY KEY (`mediumCategoryNo`, `smallCategoryNo`),
  INDEX `categoryMSmapping_smallCategoryNo_categorysmall_categoryNo_idx` (`smallCategoryNo` ASC) VISIBLE,
  CONSTRAINT `categoryMSmapping_mediumCategoryNo_categorymedium_categoryNo`
    FOREIGN KEY (`mediumCategoryNo`)
    REFERENCES `solafy`.`categorymedium` (`categoryNo`)
    ON DELETE CASCADE
    ON UPDATE RESTRICT,
  CONSTRAINT `categoryMSmapping_smallCategoryNo_categorysmall_categoryNo`
    FOREIGN KEY (`smallCategoryNo`)
