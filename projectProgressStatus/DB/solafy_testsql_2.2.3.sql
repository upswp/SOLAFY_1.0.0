...
VALUES
('DFEIJC23WOSKXCNSWQ', '호랑돌이', '글씨장인 호랑돌입니다.', 1),
('DF112C23WOSKXCNSWQ', 'A~용', '돈은 지갑을 스쳐갈뿐', 0),
('DFEIJNGRW2SKXCNSWQ', '견2', '싸피레이스 장인', 0),
('DFEIJHRDX8SKXCNSWQ', '상우하좌', '나는 PM이다', 0),
('DFEIJJHGT7SKXCNSWQ', '내가바로주희다', '파이어베이스 마스터 쭈이', 0);

-- Problem Table
-- 문제 대,중,소 테이블 생성 / 문제생성 날짜 컬럼 추가
-- 객관식 문제 
INSERT INTO problem (multipleChoice,title,uid,contents,categoryNo,type,flag)
VALUES ('button,check,text,number','input태그','DFEIJC23WOSKXCNSWQ','#### 다음 중 숫자만 입력 가능하게 하려면 빈칸에 무엇이 들어가야하는가? <br/><br/> ![아이유](https://i.pinimg.com/736x/0b/2f/8a/0b2f8a51314ab1ebe0505aee843a33b1.jpg =300x300)','0100100001',0,1);

-- 주관식 문제
INSERT INTO problem (title,uid,contents,categoryNo,type,flag)
VALUES ('MVC패턴','DF112C23WOSKXCNSWQ','#### MVC패턴의 M,V,C는 각각 무엇을 의미하는지 서술하고, MVC패턴의 장점에 대해 작성하시오.','0100200002',2,1);

-- 단답식 문제 
INSERT INTO problem (title,uid,contents,categoryNo,type,flag)
VALUES ('Java기초','DFEIJNGRW2SKXCNSWQ','#### Java는 _____프로그래밍언어이다. 빈칸에 들어가는 것은?','0200300003',1,1);
...
-- 단답식 문제2
INSERT INTO problem (title,uid,contents,categoryNo,type,flag)
VALUES ('Java입출력','DFEIJNGRW2SKXCNSWQ','#### BufferedReader br = new BufferedReader(new _______________(System.in)); 빈칸에 들어가는 것은?','0200300005',1,1);

-- 주관식 문제 2
INSERT INTO problem (title,uid,contents,categoryNo,type,flag)
VALUES ('title1','DFEIJC23WOSKXCNSWQ','#### content1','0100100001',2,1);

-- 주관식 문제 3
INSERT INTO problem (title,uid,contents,categoryNo,type,flag)
VALUES ('title2','DFEIJC23WOSKXCNSWQ','#### content2','0100100001',2,1);
