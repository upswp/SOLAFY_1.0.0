...
VALUES ('button,check,text,number','input태그','DFEIJC23WOSKXCNSWQ','다음 중 숫자만 입력 가능하게 하려면 빈칸에 무엇이 들어가야하는가?[이미지]','0100100001',0);

-- 주관식 문제
INSERT INTO problem (title,uid,contents,categoryNo,type)
VALUES ('MVC패턴','DF112C23WOSKXCNSWQ','MVC패턴의 M,V,C는 각각 무엇을 의미하는지 서술하고, MVC패턴의 장점에 대해 작성하시오.','0100100002',1);

-- 단답식 문제 
INSERT INTO problem (title,uid,contents,categoryNo,type)
VALUES ('Java기초','DFEIJNGRW2SKXCNSWQ','Java는 _____프로그래밍언어이다. 빈칸에 들어가는 것은?','0200100003',2);


-- 객관식 문제2
INSERT INTO problem (multipleChoice,title,uid,contents,categoryNo,type)
VALUES ('Bellman-ford,Dijkstra,bfs,nCr,Floyd-Warshall','그래프 탐색 알고리즘','DFEIJJHGT7SKXCNSWQ','다음 중 그래프 탐색 알고리즘이 아닌것은?','0200200003',0);

-- 단답식 문제2
INSERT INTO problem (title,uid,contents,categoryNo,type)
VALUES ('Java입출력','DFEIJNGRW2SKXCNSWQ','BufferedReader br = new BufferedReader(new _______________(System.in)); 빈칸에 들어가는 것은?','0300100004',2);

-- 주관식 문제 2
INSERT INTO problem (title,uid,contents,categoryNo,type)
VALUES ('title1','DFEIJC23WOSKXCNSWQ','content1','0200100003',1);

-- 주관식 문제 3
INSERT INTO problem (title,uid,contents,categoryNo,type)
VALUES ('title2','DFEIJC23WOSKXCNSWQ','content2','0100100001',1);
