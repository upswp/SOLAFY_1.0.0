...
-- usernickname Table
INSERT INTO userinfo(uid, nickname, statusMessage)
VALUES
('DFEIJC23WOSKXCNSWQ', '호랑돌이', '글씨장인 호랑돌입니다.'),
('DF112C23WOSKXCNSWQ', 'A~용', '돈은 지갑을 스쳐갈뿐'),
('DFEIJNGRW2SKXCNSWQ', '견2', '싸피레이스 장인'),
('DFEIJHRDX8SKXCNSWQ', '상우하좌', '나는 PM이다'),
('DFEIJJHGT7SKXCNSWQ', '내가바로주희다', '파이어베이스 마스터 쭈이');
